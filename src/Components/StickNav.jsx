...
const StickNav = () => {
    ...
    return (
        <>
            <nav className="bg-white w-full fixed border-gray-200 dark:bg-zinc-800">
                {/* <!-- Upper Navbar --> */}
                ...
                <div className="bg-gray-100 dark:bg-zinc-800">
                    <div className="max-w-screen-xl flex items-center justify-center mx-auto p-2">
                        ...
                        <a href="#" className="mx-4 text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">Inbox</a>
                        <a href="#" className="mx-4 text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">Videos</a>
                        <a href="#" className="mx-4 text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">Settings</a>
                    </div>
                </div>
            </nav>
